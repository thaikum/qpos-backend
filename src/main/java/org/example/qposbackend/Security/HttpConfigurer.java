        ...
        .authorizeHttpRequests(
            (requests) ->
                requests
                    ...
                    .hasAuthority(PrivilegesEnum.VIEW_HISTORICAL_SALES.name())
                    .requestMatchers(HttpMethod.POST, "order/get-by-range")
                    .denyAll()
                    ...
                    .hasAuthority(PrivilegesEnum.VIEW_ACCOUNTS.name())
                    ...
                    .hasAnyAuthority(
                        PrivilegesEnum.MAKE_SALE.name(),
                        PrivilegesEnum.CREATE_OFFER.name(),
                        PrivilegesEnum.VIEW_OFFER.name())
