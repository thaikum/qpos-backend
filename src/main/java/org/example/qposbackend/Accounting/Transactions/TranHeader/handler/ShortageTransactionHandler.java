...
@Setter
@Service
public class ShortageTransactionHandler extends TransactionHandler{

    public ShortageTransactionHandler(TranHeaderService tranHeaderService, AuthUserShopProvider authProvider, PartTranService partTranService, TranHeaderRepository tranHeaderRepository, ShopAccountService shopAccountService) {
